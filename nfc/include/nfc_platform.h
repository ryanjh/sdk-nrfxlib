 ...
 * @param[in, out] p_irq_priority  Pointer to the interrupt priority configuration. The user must
 ...
 * by the EasyDMA NFCT peripheral utility. Check your Product Specification for more details.
 *
