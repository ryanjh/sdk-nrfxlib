...
/** Configure CCM in compliance with product specification.
 *  Does not support multiprotocol solutions.
 *  Does not support information elements.
 */
#define CCM_PS_COMPLIANT  0

#define CCM_ALEN_ATTR_ID  11
#define CCM_MLEN_ATTR_ID  12
#define CCM_ADATA_ATTR_ID 13
#define CCM_MDATA_ATTR_ID 14
