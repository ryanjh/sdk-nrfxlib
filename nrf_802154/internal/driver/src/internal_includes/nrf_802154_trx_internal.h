...
static inline void nrf_802154_trx_enable_internal(void)
{
    ...
    /*
     * Apply radio trims. FICR fields and respective radio registers taken from
     * https://projecttools.nordicsemi.no/confluence/display/SPG/Register+Table%3A+RADIO?focusedCommentId=185190145#comment-185190145
     */
